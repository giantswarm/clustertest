...
func (c *Client) GetClusterKubeConfig(ctx context.Context, clusterName string, clusterNamespace string) (string, error) {
	if os.Getenv("E2E_USE_TELEPORT_KUBECONFIG") != "" {
		// Unlike CAPI, the kubeconfig secret generated by teleport tbot is created
		// in the namespace where tbot is deployed, which in our case is the `giantswarm` namespace.
